...
大多数 AI 教学 prompt 做的事情是一样的：压缩知识、倾倒给用户。用户感觉高效，但一周后什么都不记得。

这个仓库反其道而行。它用 7 种循证教学策略（retrieval practice、interleaving、dual coding……）强迫用户的大脑做功。不是因为听起来高级，而是因为[证据更好](https://www.pnas.org/doi/10.1073/pnas.1319030111)。
